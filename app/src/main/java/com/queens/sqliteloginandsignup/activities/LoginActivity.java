...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void verifyFromSQLite() {
        if (!inputValidation.isInputEditTextFilled(textInputEditTextEmail,textInputLayoutEmail, getResources().getString(R.string.error_message_email))) {
            return;
        }
    ...
    private void savelogindetail() {
        ...
        myEdit.putString("user_email", textInputEditTextEmail.getText().toString().trim());
        myEdit.apply();
