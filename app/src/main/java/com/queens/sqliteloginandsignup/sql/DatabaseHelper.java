...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            ...
            + COLUMN_USER_EMAIL + " TEXT," + COLUMN_USER_PASSWORD + " TEXT," +  COLUMN_USER_STEPS + " TEXT,"+  COLUMN_USER_HEIGHT + " TEXT,"+  COLUMN_USER_WEIGHT + " TEXT"+")";
    ...
    public void addUser(User user) {
        ...
        values.put(COLUMN_USER_STEPS, user.getstep());
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setstep(cursor.getString(cursor.getColumnIndex(COLUMN_USER_STEPS)));
